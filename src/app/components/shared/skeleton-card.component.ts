...
@Component({
  ...
  template: `
    <div class="ui-card" [attr.aria-label]="ariaLabel" aria-busy="true">
  ...
  styles: [
    `
      ...
      .skeleton::after { content: ''; position: absolute; inset: 0; transform: translateX(-100%); background: var(--surface-dark); animation: shimmer 1.2s infinite; }
